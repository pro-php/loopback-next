---
lang: en
title: 'Concept Two - Authentication Action'
...
Next topic: [Concept Three - Authentication Strategy](Authentication-component-strategy.md)

Previous topic: [Concept One - Authentication Decorator](Authentication-component-decorator.md)
